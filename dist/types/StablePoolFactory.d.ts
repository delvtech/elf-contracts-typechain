...
export interface StablePoolFactoryInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "create", values: [string, string, string[], BigNumberish, BigNumberish, string]): string;
...
export interface StablePoolFactory extends BaseContract {
    ...
    functions: {
        create(name: string, symbol: string, tokens: string[], amplificationParameter: BigNumberish, swapFeePercentage: BigNumberish, owner: string, overrides?: Overrides & {
    ...
    isPoolFromFactory(pool: string, overrides?: CallOverrides): Promise<boolean>;
    callStatic: {
        create(name: string, symbol: string, tokens: string[], amplificationParameter: BigNumberish, swapFeePercentage: BigNumberish, owner: string, overrides?: CallOverrides): Promise<string>;
        getPauseConfiguration(overrides?: CallOverrides): Promise<[
            BigNumber,
            BigNumber
        ] & {
