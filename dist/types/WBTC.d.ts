...
export interface WBTCInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "reclaimToken", values: [string]): string;
    ...
    decodeFunctionResult(functionFragment: "reclaimToken", data: BytesLike): Result;
...
export interface WBTC extends BaseContract {
    ...
    functions: {
        ...
        reclaimToken(_token: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
