...
export interface WeightedPool2TokensFactory extends BaseContract {
    ...
    functions: {
        create(name: string, symbol: string, tokens: string[], weights: BigNumberish[], swapFeePercentage: BigNumberish, oracleEnabled: boolean, owner: string, overrides?: Overrides & {
    ...
    isPoolFromFactory(pool: string, overrides?: CallOverrides): Promise<boolean>;
    callStatic: {
        create(name: string, symbol: string, tokens: string[], weights: BigNumberish[], swapFeePercentage: BigNumberish, oracleEnabled: boolean, owner: string, overrides?: CallOverrides): Promise<string>;
        getPauseConfiguration(overrides?: CallOverrides): Promise<[
            BigNumber,
            BigNumber
        ] & {
