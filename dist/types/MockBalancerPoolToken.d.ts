...
export interface MockBalancerPoolTokenInterface extends utils.Interface {
    functions: {
...
export interface MockBalancerPoolToken extends BaseContract {
    ...
    functions: {
        ...
        burn(sender: string, amount: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        balanceOf(account: string, overrides?: CallOverrides): Promise<BigNumber>;
        burn(sender: string, amount: BigNumberish, overrides?: CallOverrides): Promise<void>;
        decimals(overrides?: CallOverrides): Promise<number>;
