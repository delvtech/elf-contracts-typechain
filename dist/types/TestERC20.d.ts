...
export interface TestERC20Interface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "uncheckedTransfer", values: [string, BigNumberish]): string;
...
export interface TestERC20 extends BaseContract {
    ...
    functions: {
        ...
        setBalance(destination: string, amount: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        uncheckedTransfer(destination: string, amount: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    };
    DOMAIN_SEPARATOR(overrides?: CallOverrides): Promise<string>;
    ...
    callStatic: {
        ...
        setBalance(destination: string, amount: BigNumberish, overrides?: CallOverrides): Promise<void>;
        symbol(overrides?: CallOverrides): Promise<string>;
        ...
        uncheckedTransfer(destination: string, amount: BigNumberish, overrides?: CallOverrides): Promise<void>;
    };
    filters: {
