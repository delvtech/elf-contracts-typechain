...
export interface TestUserProxyInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "deriveTranche", values: [string, BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "mint", values: [BigNumberish, string, BigNumberish, string, PermitDataStruct[]]): string;
    encodeFunctionData(functionFragment: "owner", values?: undefined): string;
    encodeFunctionData(functionFragment: "setIsFrozen", values: [boolean]): string;
    encodeFunctionData(functionFragment: "setOwner", values: [string]): string;
    encodeFunctionData(functionFragment: "weth", values?: undefined): string;
    encodeFunctionData(functionFragment: "withdrawWeth", values: [
        BigNumberish,
        string,
        BigNumberish,
        BigNumberish,
    ...
    decodeFunctionResult(functionFragment: "deriveTranche", data: BytesLike): Result;
...
export interface TestUserProxy extends BaseContract {
    ...
    functions: {
        ...
        deriveTranche(position: string, expiration: BigNumberish, overrides?: CallOverrides): Promise<[string]>;
        isAuthorized(who: string, overrides?: CallOverrides): Promise<[boolean]>;
        isFrozen(overrides?: CallOverrides): Promise<[boolean]>;
        mint(_amount: BigNumberish, _underlying: string, _expiration: BigNumberish, _position: string, _permitCallData: PermitDataStruct[], overrides?: PayableOverrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        withdrawWeth(_expiration: BigNumberish, _position: string, _amountPT: BigNumberish, _amountYT: BigNumberish, _permitCallData: PermitDataStruct[], overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    };
    authorize(who: string, overrides?: Overrides & {
    ...
    callStatic: {
        ...
        isAuthorized(who: string, overrides?: CallOverrides): Promise<boolean>;
        isFrozen(overrides?: CallOverrides): Promise<boolean>;
        mint(_amount: BigNumberish, _underlying: string, _expiration: BigNumberish, _position: string, _permitCallData: PermitDataStruct[], overrides?: CallOverrides): Promise<[BigNumber, BigNumber]>;
        owner(overrides?: CallOverrides): Promise<string>;
        ...
        weth(overrides?: CallOverrides): Promise<string>;
        withdrawWeth(_expiration: BigNumberish, _position: string, _amountPT: BigNumberish, _amountYT: BigNumberish, _permitCallData: PermitDataStruct[], overrides?: CallOverrides): Promise<void>;
    };
    filters: {};
    estimateGas: {
        authorize(who: string, overrides?: Overrides & {
        ...
        deriveTranche(position: string, expiration: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        deriveTranche(position: string, expiration: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
