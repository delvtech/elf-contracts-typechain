...
export interface MockFlashLoanRecipientInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "repayInExcess", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "setRepayInExcess", values: [boolean]): string;
    encodeFunctionData(functionFragment: "setRepayLoan", values: [boolean]): string;
    ...
    decodeFunctionResult(functionFragment: "repayInExcess", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "setRepayInExcess", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setRepayLoan", data: BytesLike): Result;
...
export interface MockFlashLoanRecipient extends BaseContract {
    ...
    functions: {
        ...
        setReenter(_reenter: boolean, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        setRepayInExcess(_repayInExcess: boolean, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        setRepayLoan(_repayLoan: boolean, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        setRepayInExcess(_repayInExcess: boolean, overrides?: CallOverrides): Promise<void>;
