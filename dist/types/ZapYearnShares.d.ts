...
export interface ZapYearnSharesInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "zapSharesIn", values: [string, string, BigNumberish, BigNumberish, string, BigNumberish]): string;
    ...
    decodeFunctionResult(functionFragment: "zapSharesIn", data: BytesLike): Result;
    events: {};
}
export interface ZapYearnShares extends BaseContract {
    ...
    functions: {
        ...
        zapSharesIn(_underlying: string, _vault: string, _amount: BigNumberish, _expiration: BigNumberish, _position: string, _ptExpected: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    };
    authorize(who: string, overrides?: Overrides & {
    ...
    callStatic: {
        ...
        zapSharesIn(_underlying: string, _vault: string, _amount: BigNumberish, _expiration: BigNumberish, _position: string, _ptExpected: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber, BigNumber]>;
    };
    filters: {};
    estimateGas: {
        authorize(who: string, overrides?: Overrides & {
