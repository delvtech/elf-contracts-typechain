...
export interface CDelegatorInterface extends BaseContract {
    ...
    functions: {
        _setImplementation(implementation_: string, allowResign: boolean, becomeImplementationData: BytesLike, overrides?: Overrides & {
    ...
    implementation(overrides?: CallOverrides): Promise<string>;
    callStatic: {
        _setImplementation(implementation_: string, allowResign: boolean, becomeImplementationData: BytesLike, overrides?: CallOverrides): Promise<void>;
        implementation(overrides?: CallOverrides): Promise<string>;
    };
    filters: {
