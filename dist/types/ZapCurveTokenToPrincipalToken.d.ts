...
export interface ZapCurveTokenToPrincipalTokenInterface extends utils.Interface {
    functions: {
        ...
        "zapIn((bytes32,address,address,uint256,uint256,bool),(address,address,uint256[],address[],uint256,bytes4,uint256),(address,address,uint256[],address[],uint256,bytes4,uint256),(address,address,uint256,uint256,bytes32,bytes32,uint8)[])": FunctionFragment;
        "zapOut((bytes32,address,uint256,address,uint256,uint256,uint256,bool),(address,address,int128,address,bytes4),(address,address,int128,address,bytes4),(address,address,uint256,uint256,bytes32,bytes32,uint8)[])": FunctionFragment;
    };
    ...
    encodeFunctionData(functionFragment: "setApprovalsFor", values: [string[], string[], BigNumberish[]]): string;
    encodeFunctionData(functionFragment: "setIsFrozen", values: [boolean]): string;
    ...
    decodeFunctionResult(functionFragment: "setApprovalsFor", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setIsFrozen", data: BytesLike): Result;
...
export interface ZapCurveTokenToPrincipalToken extends BaseContract {
    ...
    functions: {
        authorize(who: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        authorized(arg0: string, overrides?: CallOverrides): Promise<[boolean]>;
        deauthorize(who: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        isAuthorized(who: string, overrides?: CallOverrides): Promise<[boolean]>;
        isFrozen(overrides?: CallOverrides): Promise<[boolean]>;
        owner(overrides?: CallOverrides): Promise<[string]>;
        setApprovalsFor(tokens: string[], spenders: string[], amounts: BigNumberish[], overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        setIsFrozen(_newState: boolean, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        setOwner(who: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        zapIn(_info: ZapInInfoStruct, _zap: ZapCurveLpInStruct, _childZap: ZapCurveLpInStruct, _permitData: PermitDataStruct[], overrides?: PayableOverrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        zapOut(_info: ZapOutInfoStruct, _zap: ZapCurveLpOutStruct, _childZap: ZapCurveLpOutStruct, _permitData: PermitDataStruct[], overrides?: PayableOverrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    };
    authorize(who: string, overrides?: Overrides & {
    ...
    callStatic: {
        ...
        isFrozen(overrides?: CallOverrides): Promise<boolean>;
        owner(overrides?: CallOverrides): Promise<string>;
        setApprovalsFor(tokens: string[], spenders: string[], amounts: BigNumberish[], overrides?: CallOverrides): Promise<void>;
        ...
        zapIn(_info: ZapInInfoStruct, _zap: ZapCurveLpInStruct, _childZap: ZapCurveLpInStruct, _permitData: PermitDataStruct[], overrides?: CallOverrides): Promise<BigNumber>;
        zapOut(_info: ZapOutInfoStruct, _zap: ZapCurveLpOutStruct, _childZap: ZapCurveLpOutStruct, _permitData: PermitDataStruct[], overrides?: CallOverrides): Promise<BigNumber>;
    };
    filters: {};
    estimateGas: {
        authorize(who: string, overrides?: Overrides & {
    ...
    populateTransaction: {
        ...
        isAuthorized(who: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
