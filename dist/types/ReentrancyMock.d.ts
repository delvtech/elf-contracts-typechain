...
export interface ReentrancyMock extends BaseContract {
    ...
    functions: {
        callback(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        countAndCall(attacker: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        countLocalRecursive(n: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        countThisRecursive(n: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        countLocalRecursive(n: BigNumberish, overrides?: CallOverrides): Promise<void>;
        countThisRecursive(n: BigNumberish, overrides?: CallOverrides): Promise<void>;
        counter(overrides?: CallOverrides): Promise<BigNumber>;
    };
    filters: {};
    estimateGas: {
