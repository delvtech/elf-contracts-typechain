...
export interface CompoundAssetProxyInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "collectRewards", values: [string]): string;
...
export interface CompoundAssetProxy extends BaseContract {
    ...
    functions: {
        ...
        collectRewards(_destination: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        balanceOf(arg0: string, overrides?: CallOverrides): Promise<BigNumber>;
        balanceOfUnderlying(_who: string, overrides?: CallOverrides): Promise<BigNumber>;
        collectRewards(_destination: string, overrides?: CallOverrides): Promise<void>;
        comp(overrides?: CallOverrides): Promise<string>;
        comptroller(overrides?: CallOverrides): Promise<string>;
        ctoken(overrides?: CallOverrides): Promise<string>;
