...
export interface SignaturesValidatorMockInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "anotherFunction", values: [string]): string;
    encodeFunctionData(functionFragment: "authenticateCall", values: [string]): string;
    encodeFunctionData(functionFragment: "decodeCalldata", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "increaseNonce", values: [string]): string;
    decodeFunctionResult(functionFragment: "anotherFunction", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "authenticateCall", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "decodeCalldata", data: BytesLike): Result;
...
export declare type AuthenticatedEventFilter = TypedEventFilter<AuthenticatedEvent>;
...
export declare type CalldataDecodedEventFilter = TypedEventFilter<CalldataDecodedEvent>;
export interface SignaturesValidatorMock extends BaseContract {
    ...
    functions: {
        anotherFunction(user: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        authenticateCall(user: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        decodeCalldata(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        getDomainSeparator(overrides?: CallOverrides): Promise<[string]>;
        getNextNonce(user: string, overrides?: CallOverrides): Promise<[BigNumber]>;
        increaseNonce(user: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    };
    anotherFunction(user: string, overrides?: Overrides & {
    ...
    filters: {
        "Authenticated(address,address)"(user?: null, sender?: null): AuthenticatedEventFilter;
        Authenticated(user?: null, sender?: null): AuthenticatedEventFilter;
        "CalldataDecoded(bytes,uint256,uint8,bytes32,bytes32)"(data?: null, deadline?: null, v?: null, r?: null, s?: null): CalldataDecodedEventFilter;
        CalldataDecoded(data?: null, deadline?: null, v?: null, r?: null, s?: null): CalldataDecodedEventFilter;
    };
    estimateGas: {
        anotherFunction(user: string, overrides?: Overrides & {
            from?: string | Promise<string>;
