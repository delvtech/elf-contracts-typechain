...
export interface ZapTrancheHopInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "hopToTranche", values: [
        string,
        string,
        BigNumberish,
        string,
    ...
    encodeFunctionData(functionFragment: "rescueTokens", values: [string, BigNumberish]): string;
    ...
    decodeFunctionResult(functionFragment: "hopToTranche", data: BytesLike): Result;
...
export interface ZapTrancheHop extends BaseContract {
    ...
    functions: {
        ...
        hopToTranche(_underlying: string, _positionFrom: string, _expirationFrom: BigNumberish, _positionTo: string, _expirationTo: BigNumberish, _amountPt: BigNumberish, _amountYt: BigNumberish, _ptExpected: BigNumberish, _ytExpected: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        isAuthorized(who: string, overrides?: CallOverrides): Promise<[boolean]>;
        isFrozen(overrides?: CallOverrides): Promise<[boolean]>;
        owner(overrides?: CallOverrides): Promise<[string]>;
        rescueTokens(token: string, amount: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        hopToTranche(_underlying: string, _positionFrom: string, _expirationFrom: BigNumberish, _positionTo: string, _expirationTo: BigNumberish, _amountPt: BigNumberish, _amountYt: BigNumberish, _ptExpected: BigNumberish, _ytExpected: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber, BigNumber]>;
        isAuthorized(who: string, overrides?: CallOverrides): Promise<boolean>;
        isFrozen(overrides?: CallOverrides): Promise<boolean>;
        owner(overrides?: CallOverrides): Promise<string>;
        rescueTokens(token: string, amount: BigNumberish, overrides?: CallOverrides): Promise<void>;
