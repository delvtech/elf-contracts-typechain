...
export interface MockERC20YearnVaultInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "report", values: [BigNumberish]): string;
...
export interface MockERC20YearnVault extends BaseContract {
    ...
    functions: {
        ...
        deposit(_amount: BigNumberish, _recipient: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        report(_deposit: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        setDepositLimit(_limit: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        withdraw(_maxShares: BigNumberish, _recipient: string, _maxLoss: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    };
    DEGRADATION_COEFFICIENT(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    callStatic: {
        ...
        decimals(overrides?: CallOverrides): Promise<number>;
        deposit(_amount: BigNumberish, _recipient: string, overrides?: CallOverrides): Promise<BigNumber>;
        governance(overrides?: CallOverrides): Promise<string>;
        isAuthorized(who: string, overrides?: CallOverrides): Promise<boolean>;
        lastReport(overrides?: CallOverrides): Promise<BigNumber>;
        lockedProfit(overrides?: CallOverrides): Promise<BigNumber>;
        ...
        setDepositLimit(_limit: BigNumberish, overrides?: CallOverrides): Promise<void>;
        ...
        withdraw(_maxShares: BigNumberish, _recipient: string, _maxLoss: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
    };
    filters: {
