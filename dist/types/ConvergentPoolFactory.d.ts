...
export interface ConvergentPoolFactoryInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "isPoolFromFactory", values: [string]): string;
    encodeFunctionData(functionFragment: "owner", values?: undefined): string;
    encodeFunctionData(functionFragment: "percentFeeGov", values?: undefined): string;
    encodeFunctionData(functionFragment: "setGov", values: [string]): string;
    encodeFunctionData(functionFragment: "setGovFee", values: [BigNumberish]): string;
...
export declare type CCPoolCreatedEventFilter = TypedEventFilter<CCPoolCreatedEvent>;
export declare type PoolCreatedEvent = TypedEvent<[string], {
    pool: string;
}>;
...
export interface ConvergentPoolFactory extends BaseContract {
    ...
    functions: {
        ...
        create(_underlying: string, _bond: string, _expiration: BigNumberish, _unitSeconds: BigNumberish, _percentFee: BigNumberish, _name: string, _symbol: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        setGov(newGov: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        setGovFee(newFee: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        authorized(arg0: string, overrides?: CallOverrides): Promise<boolean>;
        create(_underlying: string, _bond: string, _expiration: BigNumberish, _unitSeconds: BigNumberish, _percentFee: BigNumberish, _name: string, _symbol: string, overrides?: CallOverrides): Promise<string>;
    ...
    filters: {
        "CCPoolCreated(address,address)"(pool?: string | null, bondToken?: string | null): CCPoolCreatedEventFilter;
        CCPoolCreated(pool?: string | null, bondToken?: string | null): CCPoolCreatedEventFilter;
    ...
    estimateGas: {
        ...
        isPoolFromFactory(pool: string, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        isPoolFromFactory(pool: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
