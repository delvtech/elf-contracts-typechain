...
declare type EthForceSenderConstructorParams = [signer?: Signer] | ConstructorParameters<typeof ContractFactory>;
export declare class EthForceSender__factory extends ContractFactory {
    ...
    getDeployTransaction(recipient: string, overrides?: PayableOverrides & {
        from?: string | Promise<string>;
    }): TransactionRequest;
    attach(address: string): EthForceSender;
    connect(signer: Signer): EthForceSender__factory;
    static readonly bytecode = "0x6080604052604051604e380380604e83398181016040526020811015602357600080fd5b81019080805190602001909291905050508073ffffffffffffffffffffffffffffffffffffffff16fffe";
    static readonly abi: {
        inputs: {
            internalType: string;
            name: string;
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): EthForceSender;
}
export {};
